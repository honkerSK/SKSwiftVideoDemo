...
let flowerImage = UIImage(contentsOfFile: Bundle.main.path(forResource: "road", ofType: "jpg")!)!
let MaYuImage = UIImage(contentsOfFile: Bundle.main.path(forResource: "rina", ofType: "jpg")!)!

//let flowerImage = UIImage(named: "Flower")!
//let MaYuImage = UIImage(named: "girl")!
...
//                }),
            ...
            "Visual effects 视觉特效": [
                ...
                FilterModel(name: "KuwaharaFilter Kuwahara滤镜",
                            ...
                            valueChangedCallback: { (filter, value) in
                                (filter as! KuwaharaFilter).radius = Float(Int(value))
                }),
